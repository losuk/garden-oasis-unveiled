...
const treatments = [
  {
    name: "The Nakasero Ritual",
    time: "90 min",
    price: "$180",
    copy: "A full-body massage with warm coconut oil and shea, closed with a scalp treatment.",
  },
  {
    name: "Garden Facial",
    time: "60 min",
    price: "$140",
    copy: "A gentle facial using cold-pressed avocado and passion fruit from our own trees.",
  },
  {
    name: "Explorer's Recovery",
    time: "75 min",
    price: "$160",
    copy: "A deep-tissue massage for those returning from safari or the mountains.",
  },
  {
    name: "Two-hour Retreat",
    time: "120 min",
    price: "$260",
    copy: "Body scrub, massage, and a botanical bath — the complete afternoon.",
  },
];
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-[1100px] px-6 lg:px-12">
          ...
          <div className="mt-16 grid gap-10 md:grid-cols-2">
            {treatments.map((t) => (
              <div key={t.name} className="border-t border-border pt-8">
                ...
                <p className="mt-2 text-[11px] tracking-[0.22em] uppercase text-muted-foreground">
                  {t.time}
                </p>
          ...
          <div className="mt-20 text-center">
            <a href="mailto:spa@eminpasha.com" className="btn-outline">
              Book a treatment
            </a>
          </div>
        </div>
